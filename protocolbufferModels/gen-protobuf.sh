...
for file in ${SRCROOT}/protocolbufferModels/protobufModels/gj-Chat/*
do
echo $file is file path \! ;
protoc --plugin=/usr/local/bin/protoc-gen-objc $file --objc_out=${SRCROOT}/protocolbufferModels/gj-chatProtocolbufferModels/chat --proto_path=${SRCROOT}/protocolbufferModels/protobufModels/gj-Chat/
done
